...
const (
	...
	// DefaultURL is Fleet's public TUF server. Used by fleetctl package to download
	// orbit and osqueryd binaries for packaging. The agent itself doesn't use this
	// at runtime when --disable-updates is set (Phase 1).
